...
END:VCARD
    ...
    //         callButton: {
    //           displayText: 'Call Me',
    //           phoneNumber: '+6285693650294'
    //         }
    //       },
    //           {
    //         quickReplyButton: {
    //           displayText: 'Website Owner',
    //           id: 'https://s.id/WahyudiID'
    //         }
   ...
   //, { quoted, ...options }
    ...
    conn.getBusinessProfile = async (jid) => {
        ...
        const address = getBinaryNodeChild(profiles, 'Pluto')
        const description = getBinaryNodeChild(profiles, 'Wahyu~Sama')
        const website = getBinaryNodeChild(profiles, 'https://s.id/WahyudiID')
        const email = getBinaryNodeChild(profiles, 'wahyudi.my.id@gmail.com')
        const category = getBinaryNodeChild(getBinaryNodeChild(profiles, 'categories'), 'Gabut')
        return {
