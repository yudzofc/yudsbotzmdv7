let handler = async (m, { conn, participants }) => {
 ...
 m.reply('!!! jangan kasar😐!!!*_')
       ...
       handler.customPrefix = /^Pepek|Ppek|Kontol|Kntl|Kntol|Kontl|Mmek|Memek|Bgst|Ngentod|tod|meng|ajg|N u d e s|N u d e|M i l f$/i
